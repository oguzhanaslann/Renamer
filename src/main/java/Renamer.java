...
public class Renamer {
    public static final String PATH_OF_DIR = "/.../.../.../...";
    public static final String FILE_MIME_TYPE = ".png";
    public static final String RENAME_TEMPLATE = "ic_alianz_<x>" + FILE_MIME_TYPE;
    ...
    public static void main(String[] args) {
        ...
        for (int childIndex = 0; childIndex < files.length; childIndex++) {
            ...
            String fileNewName = RENAME_TEMPLATE.replace("<x>", suffixOfFile(childIndex));
